...
#python ./IWIN_manual_restructuring.py -s MSBillefjord -t 20230321 20230922
python ./IWIN_manual_restructuring.py -s MSPolargirl -t 20230523 20231026
#python ./IWIN_manual_restructuring.py -s MSBerg -t 20230521 20231026

#python ./IWIN_manual_restructuring.py -s MSBillefjord -t 20240222 "$ENDDAY"
python ./IWIN_manual_restructuring.py -s MSPolargirl -t 20240527 "$ENDDAY"
#python ./IWIN_manual_restructuring.py -s MSBard -t 20240502 "$ENDDAY"